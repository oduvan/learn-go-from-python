...
1. **Керує мовними функціями.** Модуль з `go 1.23.0` може використовувати мовні можливості, додані до Go 1.23 включно (наприклад, ітератори range-over-func, введені в 1.23 і розглянуті в статті [Ітератори](../06-text-time-and-data/06-iterators.md)). Старіші toolchain відмовляться збирати такий модуль.
