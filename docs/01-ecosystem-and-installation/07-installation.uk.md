...
Дивіться [декілька версій Go](06-multiple-go-versions.md) для ширшого контексту — `GOTOOLCHAIN=auto` автоматично обробляє вибір версії для кожного проєкту, щойно у вас встановлено будь-який Go.
