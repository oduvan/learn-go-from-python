...
структур і рефлексію. Стаття про [структури](../02-language-basics/10-structs.md)
уже познайомила з синтаксисом тегів; ця стаття — про поведінку, у якої є
кілька гострих країв, з якими варто зустрітися свідомо.
...
Переривання циклу на будь-якій помилці змішує «кінець вхідних даних» з
«погані вхідні дані»; у справжньому коді порівнюють з `io.EOF`. Декодери
