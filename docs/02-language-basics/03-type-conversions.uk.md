...
Той самий синтаксис `T(x)` підходить для будь-яких двох типів, що мають спільний базовий тип, — не лише для зумовлених числових. Повна розповідь є в [07-custom-types.md](07-custom-types.md); коротко:
