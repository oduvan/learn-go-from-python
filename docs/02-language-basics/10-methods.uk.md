...
поведінка — поширений патерн у Go для таких речей, як реалізації `sort.Interface`.
...
реалізовувати інтерфейси. Інтерфейс задовольняється типом, чий набір методів
містить методи інтерфейсу. Інтерфейси розглядатимуться окремо; запам'ятайте
правило:
