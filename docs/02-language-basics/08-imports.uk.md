...
2. **Видимі лише експортовані назви.** Ідентифікатори з великої літери перетинають межі пакетів; рядкові — ні. (Дивіться правило капіталізації в [02-basic-types.md](02-basic-types.md).)
