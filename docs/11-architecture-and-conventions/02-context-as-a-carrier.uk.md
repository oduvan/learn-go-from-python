...
життя було прив'язане до запиту: транзакція, що несеться в контексті,
переживає відв'язування й тепер вказує на щось уже закомічене. Якщо
відв'язуєте, спершу зніміть усе, прив'язане до запиту.
